...
# GLOBALS
#======================================
URL = 'https://www.amazon.ca/TCL-Dolby-Vision-QLED-Smart/dp/B088517GLM'             # URL for TCL Series 5 50 inch TV
headers = {"User-Agent": 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36'
                         ' (KHTML, like Gecko) Chrome/86.0.4240.75 Safari/537.36'}
ATTEMPTS = 10
CONTACTS = os.path.join(os.path.dirname(__file__), 'contacts.txt')
SENDER = {'email':'python@gmail.com', 'password': '123456'}           # Place the email you wish to send from
